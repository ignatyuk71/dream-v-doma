<template>
  <div class="card mb-4 p-4">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" v-model="form.old_price">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      >
      <div v-if="errors?.quantity_in_stock" class="invalid-feedback">
        {{ errors.quantity_in_stock }}
      </div>
    </div>

    <div class="form-check form-switch mb-2">
      <input class="form-check-input" type="checkbox" id="stockSwitch" v-model="form.is_available">
      <label class="form-check-label" for="stockSwitch">Є в наявності</label>
    </div>
    <div class="form-check form-switch">
      <input class="form-check-input" type="checkbox" id="popularSwitch" v-model="form.is_popular">
