<template>
  ...
  export default {
    ...
    props: {
      ...
      categoryId: {
        type: [String, Number], // Vue не вміє перевіряти на null, тому null — через default
        default: null
      }
    },
    data() {
    ...
    methods: {
      ...
      async uploadImage(file) {
        ...
        // categoryId може бути null при додаванні — бек має вміти це прийняти!
        if (this.categoryId) formData.append('category_id', this.categoryId)
        this.uploading = true
        try {
