...
<div class="row">
  ...
  <tbody>
    <tr>
      ...
      <td>299.00 ₴</td>
      <td>Взуття</td>
      <td><span class="badge bg-success rounded-pill">Активний</span></td>
      <td class="text-end">
        <a href="#" class="btn btn-sm btn-outline-primary rounded-pill me-1">Перегляд</a>
        <a href="#" class="btn btn-sm btn-warning text-white rounded-pill me-1">Редагувати</a>
        <a href="#" class="btn btn-sm btn-danger rounded-pill">Видалити</a>
      </td>
    </tr>
    <tr>
      <td>2</td>
      ...
      <td>549.00 ₴</td>
      <td>Одяг</td>
      <td><span class="badge bg-secondary rounded-pill">Неактивний</span></td>
      <td class="text-end">
        <a href="#" class="btn btn-sm btn-outline-primary rounded-pill me-1">Перегляд</a>
        <a href="#" class="btn btn-sm btn-warning text-white rounded-pill me-1">Редагувати</a>
        <a href="#" class="btn btn-sm btn-danger rounded-pill">Видалити</a>
