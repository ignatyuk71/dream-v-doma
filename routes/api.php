...
// Знімаємо дефолтний throttle:api і ставимо свій — 120 запитів/хв з IP
Route::prefix('track')
    ->withoutMiddleware(ThrottleRequests::class)
    ->middleware('throttle:120,1')
    ->group(function () {
        Route::post('/pv',   [TrackController::class, 'pv'])->name('track.pv');   // PageView
        Route::post('/vc',   [TrackController::class, 'vc'])->name('track.vc');   // ViewContent
        Route::post('/atc',  [TrackController::class, 'atc'])->name('track.atc'); // AddToCart
        Route::post('/ic',   [TrackController::class, 'ic'])->name('track.ic');   // InitiateCheckout
        Route::post('/lead', [TrackController::class, 'lead'])->name('track.lead'); // Lead
