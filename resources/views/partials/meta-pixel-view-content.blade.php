...
(function () {
  ...
  // спільний event_id для дедупу (той самий для браузера і сервера)
  ...
  /* 1) БРАУЗЕРНИЙ ViewContent — мінімальний, “звичайний” набір полів */
  var pixelPayload = {
    content_ids: [pid],
  ...
  /* 2) СЕРВЕРНИЙ ViewContent — детальний пейлоад */
  try {
