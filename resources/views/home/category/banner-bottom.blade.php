              ...
              <div class="row align-items-center position-relative z-1">
                <div class="col-md-6 pt-5 pt-md-0 mb-2 mb-md-0">
                  <div class="text-center text-md-start py-md-5 px-4 ps-md-5 pe-md-0 me-md-n5">
                    <h3 class="text-uppercase fw-bold ps-xxl-3 pb-2 mb-1">Комфорт щодня</h3>
                    <p class="text-body-emphasis ps-xxl-3 mb-0">Домашні тапочки, які ти полюбиш з першого кроку</p>
                  </div>
                </div>
