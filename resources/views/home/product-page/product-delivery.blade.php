@php
    ...
    // ── Тарифи Нової Пошти (легко редагувати при потребі)
    $np_branch_from  = 80;   // відділення / поштомат (до 2 кг)
    $np_courier_from = 115;  // кур’єр (до 2 кг) ≈ базовий + 35 грн
    $np_rural_plus   = 25;   // доплата для сіл/селищ
    $np_long_side    = 50;   // якщо довга сторона > 120 см
@endphp
      ...
      <div class="accordion-body">
        ...
        <table class="table table-sm text-muted small mb-2" style="max-width: 540px;">
          ...
          <tbody>
            <tr>
              <td>
                <strong>Нова Пошта (відділення / поштомат)</strong><br>
                Отримуйте у зручному відділенні по всій Україні
              </td>
              <td>1–2 робочі дні</td>
              <td>від {{ $np_branch_from }}&nbsp;грн (до 2&nbsp;кг)</td>
            </tr>
            <tr>
              <td>
                <strong>Нова Пошта (кур’єр)</strong><br>
                Доставка прямо до ваших дверей
              </td>
              <td>1–2 робочі дні</td>
              <td>від {{ $np_courier_from }}&nbsp;грн (до 2&nbsp;кг)</td>
            </tr>
          </tbody>
        </table>

        <ul class="small text-muted mb-2 ps-3">
          <li>Точна вартість розраховується за тарифами перевізника (вага та габарити).</li>
          <li>Доставка в села/селища: +{{ $np_rural_plus }}&nbsp;грн до тарифу.</li>
          <li>Якщо довга сторона відправлення &gt; 120&nbsp;см: +{{ $np_long_side }}&nbsp;грн за місце.</li>
          <li>Після оформлення замовлення ви отримаєте SMS/Viber з номером ТТН для відстеження.</li>
        </ul>
